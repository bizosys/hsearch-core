...
public final class Cell12< K1, K2, K3, K4, K5, K6, K7, K8, K9, K10, K11,V> extends CellBase<K1> {
	...
	public Cell12 (  final ISortedByte<K1> k1Sorter, final ISortedByte<K2> k2Sorter, final ISortedByte<K3> k3Sorter, final ISortedByte<K4> k4Sorter, final ISortedByte<K5> k5Sorter, final ISortedByte<K6> k6Sorter, final ISortedByte<K7> k7Sorter, final ISortedByte<K8> k8Sorter, final ISortedByte<K9> k9Sorter, final ISortedByte<K10> k10Sorter, final ISortedByte<K11> k11Sorter, final ISortedByte<V> vSorter) {
	...
	public final void getNotMap(final K1 exactValue, final Map<K1, Cell11< K2, K3, K4, K5, K6, K7, K8, K9, K10, K11,V>> rows) throws IOException 
	{
		if ( null == data) {
			System.err.println("Null Data - It should be an warning");
			return;
	...
	public final void getInMap(final K1[] inValues, final Map<K1, Cell11< K2, K3, K4, K5, K6, K7, K8, K9, K10, K11,V>> rows) throws IOException 
	{
		if ( null == data) {
			System.err.println("Null Data - It should be an warning");
			return;
