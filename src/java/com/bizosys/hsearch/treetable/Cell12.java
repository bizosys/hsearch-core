...
public class Cell12< K1, K2, K3, K4, K5, K6, K7, K8, K9, K10, K11,V> extends CellBase<K1> {
	...
	public void parseElements() throws IOException {
		...
		List<Cell11< K2, K3, K4, K5, K6, K7, K8, K9, K10, K11,V>> allValues = new ArrayList<Cell11< K2, K3, K4, K5, K6, K7, K8, K9, K10, K11,V>>(allKeysT);
		values(allValues);
		...
		Iterator<Cell11< K2, K3, K4, K5, K6, K7, K8, K9, K10, K11,V>> itrVal = allValues.iterator();
