...
public final class Cell4< K1, K2, K3,V> extends CellBase<K1> {
	...
	//Builder
	public final void put(final K1 k1,final K2 k2,final K3 k3, final V v) {
	...
	public final void sort(final Comparator<CellKeyValue<K3, V>> comp) {
	...
	public final byte[] toBytes(final Comparator<CellKeyValue<K3, V>> comp) throws IOException {
		this.sort(comp);
		return toBytes();
	}	
	...
	public final Map<K1, Cell3< K2, K3,V>> getMap(final byte[] data) throws IOException {
	...
	public final Map<K1, Cell3< K2, K3,V>> getMap() throws IOException {
	...
	public final void getMap(final K1 exactValue, final K1 minimumValue, final K1 maximumValue, final Map<K1, Cell3< K2, K3,V>> rows) throws IOException 
	{
		if ( null == data) {
	...
	public final void getInMap(final K1[] inValues, final Map<K1, Cell3< K2, K3,V>> rows) throws IOException 
	{
		if ( null == data) {
			System.err.println("Null Data - It should be an warning");
			return;
	 ...
	 * @throws IOException
	 */
	public final Collection<Cell3< K2, K3,V>> values(final K1 exactValue) throws IOException {
		Collection<Cell3< K2, K3,V>> values = new ArrayList<Cell3< K2, K3,V>>();
		values(exactValue, null, null, values);
		return values;
	}
	public final Collection<Cell3< K2, K3,V>> values(final K1 minimumValue, final K1 maximumValue) throws IOException {
		Collection<Cell3< K2, K3,V>> values = new ArrayList<Cell3< K2, K3,V>>();
		values(null, minimumValue, maximumValue, values);
		return values;
	}	
	
	public final void values(final K1 exactValue, final Collection<Cell3< K2, K3,V>> foundValues) throws IOException {
		values(exactValue, null, null, foundValues);
	}
	
	public final void values(final K1 minimumValue, final K1 maximumValue, final Collection<Cell3< K2, K3,V>> foundValues) throws IOException {
	...
	private final void values(final K1 exactValue, final K1 minimumValue, final K1 maximumValue, 
			final Collection<Cell3< K2, K3,V>> foundValues) throws IOException {
		if ( null == data) {
			System.err.println("Null Data - It should be an warning");
			return;
		}
	...
	public final Collection<Cell3< K2, K3,V>> values() throws IOException {
		Collection<Cell3< K2, K3,V>> values = new ArrayList<Cell3< K2, K3,V>>();
		values(values);
		return values;
	}	
	
	public final void values(final Collection<Cell3< K2, K3,V>> values) throws IOException {
		if ( null == data) {
			System.err.println("Null Data - It should be an warning");
			return;
		}
	...
	public final class Callback extends EmptyList {
		...
		public Callback(final Map<K1, Cell3< K2, K3,V>> rows, final ISortedByte<byte[]> valSorter ) {
			this.rows = rows;
