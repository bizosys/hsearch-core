...
public class Cell6< K1, K2, K3, K4, K5,V> extends CellBase<K1> {
	...
	public Cell6 (ISortedByte<K1> k1Sorter,ISortedByte<K2> k2Sorter,ISortedByte<K3> k3Sorter,ISortedByte<K4> k4Sorter,ISortedByte<K5> k5Sorter, ISortedByte<V> vSorter) {
	...
	public Cell6 (ISortedByte<K1> k1Sorter,ISortedByte<K2> k2Sorter,ISortedByte<K3> k3Sorter,ISortedByte<K4> k4Sorter,ISortedByte<K5> k5Sorter, 
	...
	public void parseElements() throws IOException {
		...
		List<Cell5< K2, K3, K4, K5,V>> allValues = new ArrayList<Cell5< K2, K3, K4, K5,V>>(allKeysT);
		values(allValues);
		...
		Iterator<Cell5< K2, K3, K4, K5,V>> itrVal = allValues.iterator();
