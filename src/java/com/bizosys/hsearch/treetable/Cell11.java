...
public class Cell11< K1, K2, K3, K4, K5, K6, K7, K8, K9, K10,V> extends CellBase<K1> {
	...
	private void values(K1 exactValue, K1 minimumValue, K1 maximumValue, 
		...
		for (int position : foundPositions) {
			foundValues.add( new Cell10< K2, K3, K4, K5, K6, K7, K8, K9, K10,V>(
				k2Sorter,k3Sorter,k4Sorter,k5Sorter,k6Sorter,k7Sorter,k8Sorter,k9Sorter,k10Sorter, vSorter, sortedBA.getValueAt(position)));
		}
	}
	...
	public void values(Collection<Cell10< K2, K3, K4, K5, K6, K7, K8, K9, K10,V>> values) throws IOException {
		...
		for ( int i=0; i<size; i++) {
			values.add( new Cell10< K2, K3, K4, K5, K6, K7, K8, K9, K10,V>( k2Sorter,k3Sorter,k4Sorter,k5Sorter,k6Sorter,k7Sorter,k8Sorter,k9Sorter,k10Sorter, vSorter, sortedBA.getValueAt(i)) );
		}
	}
