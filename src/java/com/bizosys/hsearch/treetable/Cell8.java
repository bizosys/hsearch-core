...
public final class Cell8< K1, K2, K3, K4, K5, K6, K7,V> extends CellBase<K1> {
	...
	public Map<K1, Cell7< K2, K3, K4, K5, K6, K7,V>> sortedList;
	public Cell8 (  final ISortedByte<K1> k1Sorter, final ISortedByte<K2> k2Sorter, final ISortedByte<K3> k3Sorter, final ISortedByte<K4> k4Sorter, final ISortedByte<K5> k5Sorter, final ISortedByte<K6> k6Sorter, final ISortedByte<K7> k7Sorter, final ISortedByte<V> vSorter) {
	...
	public Cell8 (  final ISortedByte<K1> k1Sorter, final ISortedByte<K2> k2Sorter, final ISortedByte<K3> k3Sorter, final ISortedByte<K4> k4Sorter, final ISortedByte<K5> k5Sorter, final ISortedByte<K6> k6Sorter, final ISortedByte<K7> k7Sorter, 
			final ISortedByte<V> vSorter, final Map<K1, Cell7< K2, K3, K4, K5, K6, K7,V>> sortedList ) {
		this(k1Sorter,k2Sorter,k3Sorter,k4Sorter,k5Sorter,k6Sorter,k7Sorter,vSorter);
	...
	//Builder
	public final void put(final K1 k1,final K2 k2,final K3 k3,final K4 k4,final K5 k5,final K6 k6,final K7 k7, final V v) {
		if ( null == sortedList) sortedList = new TreeMap<K1, Cell7< K2, K3, K4, K5, K6, K7,V> >();
		
		Cell7< K2, K3, K4, K5, K6, K7,V> val = null;
		if ( sortedList.containsKey(k1)) val = sortedList.get(k1);
		else {
			val = new Cell7< K2, K3, K4, K5, K6, K7,V>(k2Sorter,k3Sorter,k4Sorter,k5Sorter,k6Sorter,k7Sorter, vSorter);
			sortedList.put(k1, val);
		}
		val.put(k2,k3,k4,k5,k6,k7, v);
	}
	
	public final void sort(final Comparator<CellKeyValue<K7, V>> comp) {
		if ( null == sortedList) return;
		for (Cell7< K2, K3, K4, K5, K6, K7,V> entry : sortedList.values()) {
			entry.sort(comp);
		}
	}	
	
	public final byte[] toBytes(final Comparator<CellKeyValue<K7, V>> comp) throws IOException {
		this.sort(comp);
		return toBytes();
	}	
	...
	public final Map<K1, Cell7< K2, K3, K4, K5, K6, K7,V>> getMap(final byte[] data) throws IOException {
	...
	public final Map<K1, Cell7< K2, K3, K4, K5, K6, K7,V>> getMap() throws IOException {
	...
	public final void getMap(final K1 exactValue, final K1 minimumValue, final K1 maximumValue, final Map<K1, Cell7< K2, K3, K4, K5, K6, K7,V>> rows) throws IOException 
	{
		if ( null == data) {
	...
	public final void getNotMap(final K1 exactValue, final Map<K1, Cell7< K2, K3, K4, K5, K6, K7,V>> rows) throws IOException 
	{
		if ( null == data) {
			System.err.println("Null Data - It should be an warning");
			return;
	...
	public final void getInMap(final K1[] inValues, final Map<K1, Cell7< K2, K3, K4, K5, K6, K7,V>> rows) throws IOException 
	{
		if ( null == data) {
			System.err.println("Null Data - It should be an warning");
			return;
	 ...
	 * @throws IOException
	 */
	public final Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> values(final K1 exactValue) throws IOException {
		Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> values = new ArrayList<Cell7< K2, K3, K4, K5, K6, K7,V>>();
		values(exactValue, null, null, values);
		return values;
	}
	public final Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> values(final K1 minimumValue, final K1 maximumValue) throws IOException {
		Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> values = new ArrayList<Cell7< K2, K3, K4, K5, K6, K7,V>>();
		values(null, minimumValue, maximumValue, values);
		return values;
	}	
	
	public final void values(final K1 exactValue, final Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> foundValues) throws IOException {
		values(exactValue, null, null, foundValues);
	}
	
	public final void values(final K1 minimumValue, final K1 maximumValue, final Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> foundValues) throws IOException {
	...
	private final void values(final K1 exactValue, final K1 minimumValue, final K1 maximumValue, 
			final Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> foundValues) throws IOException {
		if ( null == data) {
			System.err.println("Null Data - It should be an warning");
			return;
		}
		...
		for (int position : foundPositions) {
			...
			foundValues.add( new Cell7< K2, K3, K4, K5, K6, K7,V>(
				k2Sorter,k3Sorter,k4Sorter,k5Sorter,k6Sorter,k7Sorter, vSorter, sec));
		}
		ObjectFactory.getInstance().putIntegerList(foundPositions);
	}
	
	public final Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> values() throws IOException {
		Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> values = new ArrayList<Cell7< K2, K3, K4, K5, K6, K7,V>>();
		values(values);
		return values;
	}	
	
	public final void values(final Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> values) throws IOException {
		if ( null == data) {
			System.err.println("Null Data - It should be an warning");
			return;
		}
		...
		for ( int i=0; i<size; i++) {
			...
			BytesSection sec = new BytesSection(data.data, ref.offset, ref.length);
			values.add( new Cell7< K2, K3, K4, K5, K6, K7,V>( k2Sorter,k3Sorter,k4Sorter,k5Sorter,k6Sorter,k7Sorter, vSorter, sec) );
		}
	}
	
	public final void parseElements() throws IOException {
		if ( null == this.sortedList) this.sortedList = new TreeMap<K1, Cell7< K2, K3, K4, K5, K6, K7,V>>();
		...
		for ( int i=0; i<sizeK; i++) {
			valSorter.getValueAtReference(i, ref);
			BytesSection sec = new BytesSection(data.data, ref.offset, ref.length);
			sortedList.put(k1Sorter.getValueAt(i), new Cell7< K2, K3, K4, K5, K6, K7,V>( k2Sorter,k3Sorter,k4Sorter,k5Sorter,k6Sorter,k7Sorter, vSorter, sec));
		}
	}
	...
	protected final List<byte[]> getEmbeddedCellBytes() throws IOException {
		...
		for (Cell7< K2, K3, K4, K5, K6, K7,V> cell7 : sortedList.values()) {
			values.add(cell7.toBytes());
		}
		return values;
	}
	...
	public final class Callback extends EmptyList {
		...
		Map<K1, Cell7< K2, K3, K4, K5, K6, K7,V>> rows;
		
		public Callback(final Map<K1, Cell7< K2, K3, K4, K5, K6, K7,V>> rows, final ISortedByte<byte[]> valSorter ) {
			this.rows = rows;
		...
		public final boolean add(final Integer position) {
			...
			Cell7< K2, K3, K4, K5, K6, K7,V> cell = new Cell7< K2, K3, K4, K5, K6, K7,V>(
				k2Sorter,k3Sorter,k4Sorter,k5Sorter,k6Sorter,k7Sorter, vSorter, valueSection);
