...
public class Cell8< K1, K2, K3, K4, K5, K6, K7,V> extends CellBase<K1> {
	...
	public void getMap(K1 exactValue, K1 minimumValue, K1 maximumValue, Map<K1, Cell7< K2, K3, K4, K5, K6, K7,V>> rows) throws IOException 
	{
		...
		for (int position : foundPositions) {
			Cell7< K2, K3, K4, K5, K6, K7,V> cell5 = new Cell7< K2, K3, K4, K5, K6, K7,V>(
					k2Sorter,k3Sorter,k4Sorter,k5Sorter,k6Sorter,k7Sorter, vSorter, valuesA.getValueAt(position) );
	...
	private void values(K1 exactValue, K1 minimumValue, K1 maximumValue, 
		...
		for (int position : foundPositions) {
			foundValues.add( new Cell7< K2, K3, K4, K5, K6, K7,V>(
				k2Sorter,k3Sorter,k4Sorter,k5Sorter,k6Sorter,k7Sorter, vSorter, sortedBA.getValueAt(position)));
		}
	}
	...
	public void values(Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> values) throws IOException {
		...
		for ( int i=0; i<size; i++) {
			values.add( new Cell7< K2, K3, K4, K5, K6, K7,V>( k2Sorter,k3Sorter,k4Sorter,k5Sorter,k6Sorter,k7Sorter, vSorter, sortedBA.getValueAt(i)) );
		}
	}
