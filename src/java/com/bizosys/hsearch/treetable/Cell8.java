...
public class Cell8< K1, K2, K3, K4, K5, K6, K7,V> extends CellBase<K1> {
	...
	public Cell8 (ISortedByte<K1> k1Sorter,ISortedByte<K2> k2Sorter,ISortedByte<K3> k3Sorter,ISortedByte<K4> k4Sorter,ISortedByte<K5> k5Sorter,ISortedByte<K6> k6Sorter,ISortedByte<K7> k7Sorter, ISortedByte<V> vSorter) {
	...
	public Cell8 (ISortedByte<K1> k1Sorter,ISortedByte<K2> k2Sorter,ISortedByte<K3> k3Sorter,ISortedByte<K4> k4Sorter,ISortedByte<K5> k5Sorter,ISortedByte<K6> k6Sorter,ISortedByte<K7> k7Sorter, 
			ISortedByte<V> vSorter, Map<K1, Cell7< K2, K3, K4, K5, K6, K7,V>> sortedList ) {
	...
	//Builder
	public void put(K1 k1,K2 k2,K3 k3,K4 k4,K5 k5,K6 k6,K7 k7, V v) {
	...
	public void sort(Comparator<CellKeyValue<K7, V>> comp) {
	...
	public byte[] toBytes(Comparator<CellKeyValue<K7, V>> comp) throws IOException {
		this.sort(comp);
		return toBytes();
	}	
	...
	public Map<K1, Cell7< K2, K3, K4, K5, K6, K7,V>> getMap(byte[] data) throws IOException {
	...
	public Map<K1, Cell7< K2, K3, K4, K5, K6, K7,V>> getMap() throws IOException {
	...
	public void getMap(K1 exactValue, K1 minimumValue, K1 maximumValue, Map<K1, Cell7< K2, K3, K4, K5, K6, K7,V>> rows) throws IOException 
	{
		if ( null == data) {
	 ...
	 * @throws IOException
	 */
	public Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> values(K1 exactValue) throws IOException {
		Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> values = new ArrayList<Cell7< K2, K3, K4, K5, K6, K7,V>>();
		values(exactValue, null, null, values);
		return values;
	}
	public Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> values(K1 minimumValue, K1 maximumValue) throws IOException {
		Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> values = new ArrayList<Cell7< K2, K3, K4, K5, K6, K7,V>>();
		values(null, minimumValue, maximumValue, values);
		return values;
	}	
	
	public void values(K1 exactValue, Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> foundValues) throws IOException {
		values(exactValue, null, null, foundValues);
	}
	
	public void values(K1 minimumValue, K1 maximumValue, Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> foundValues) throws IOException {
		values(null, minimumValue, maximumValue, foundValues);
	}
	
	private void values(K1 exactValue, K1 minimumValue, K1 maximumValue, 
			Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> foundValues) throws IOException {
		if ( null == data) {
			System.err.println("Null Data - It should be an warning");
			return;
		}
	...
	public Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> values() throws IOException {
		Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> values = new ArrayList<Cell7< K2, K3, K4, K5, K6, K7,V>>();
		values(values);
		return values;
	}	
	
	public void values(Collection<Cell7< K2, K3, K4, K5, K6, K7,V>> values) throws IOException {
		if ( null == data) {
			System.err.println("Null Data - It should be an warning");
			return;
		}
	...
	public void parseElements() throws IOException {
		...
		List<Cell7< K2, K3, K4, K5, K6, K7,V>> allValues = new ArrayList<Cell7< K2, K3, K4, K5, K6, K7,V>>(allKeysT);
		values(allValues);
		...
		Iterator<Cell7< K2, K3, K4, K5, K6, K7,V>> itrVal = allValues.iterator();
	...
	public final class Callback extends EmptyList {
		...
		public Callback(Map<K1, Cell7< K2, K3, K4, K5, K6, K7,V>> rows, ISortedByte<byte[]> valSorter ) {
			this.rows = rows;
