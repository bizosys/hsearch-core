...
public final class Cell7< K1, K2, K3, K4, K5, K6,V> extends CellBase<K1> {
	...
	public Cell7 (  final ISortedByte<K1> k1Sorter, final ISortedByte<K2> k2Sorter, final ISortedByte<K3> k3Sorter, final ISortedByte<K4> k4Sorter, final ISortedByte<K5> k5Sorter, final ISortedByte<K6> k6Sorter, final ISortedByte<V> vSorter) {
	...
	public Cell7 (  final ISortedByte<K1> k1Sorter, final ISortedByte<K2> k2Sorter, final ISortedByte<K3> k3Sorter, final ISortedByte<K4> k4Sorter, final ISortedByte<K5> k5Sorter, final ISortedByte<K6> k6Sorter, 
			final ISortedByte<V> vSorter, final Map<K1, Cell6< K2, K3, K4, K5, K6,V>> sortedList ) {
	...
	//Builder
	public final void put(final K1 k1,final K2 k2,final K3 k3,final K4 k4,final K5 k5,final K6 k6, final V v) {
	...
	public final void sort(final Comparator<CellKeyValue<K6, V>> comp) {
	...
	public final byte[] toBytes(final Comparator<CellKeyValue<K6, V>> comp) throws IOException {
		this.sort(comp);
		return toBytes();
	}	
	...
	public final Map<K1, Cell6< K2, K3, K4, K5, K6,V>> getMap(final byte[] data) throws IOException {
	...
	public final Map<K1, Cell6< K2, K3, K4, K5, K6,V>> getMap() throws IOException {
	...
	public final void getMap(final K1 exactValue, final K1 minimumValue, final K1 maximumValue, final Map<K1, Cell6< K2, K3, K4, K5, K6,V>> rows) throws IOException 
	{
		if ( null == data) {
	...
	public final void getNotMap(final K1 exactValue, final Map<K1, Cell6< K2, K3, K4, K5, K6,V>> rows) throws IOException 
	{
		if ( null == data) {
			System.err.println("Null Data - It should be an warning");
			return;
	...
	public final void getInMap(final K1[] inValues, final Map<K1, Cell6< K2, K3, K4, K5, K6,V>> rows) throws IOException 
	{
		if ( null == data) {
			System.err.println("Null Data - It should be an warning");
			return;
	 ...
	 * @throws IOException
	 */
	public final Collection<Cell6< K2, K3, K4, K5, K6,V>> values(final K1 exactValue) throws IOException {
		Collection<Cell6< K2, K3, K4, K5, K6,V>> values = new ArrayList<Cell6< K2, K3, K4, K5, K6,V>>();
		values(exactValue, null, null, values);
		return values;
	}
	public final Collection<Cell6< K2, K3, K4, K5, K6,V>> values(final K1 minimumValue, final K1 maximumValue) throws IOException {
		Collection<Cell6< K2, K3, K4, K5, K6,V>> values = new ArrayList<Cell6< K2, K3, K4, K5, K6,V>>();
		values(null, minimumValue, maximumValue, values);
		return values;
	}	
	
	public final void values(final K1 exactValue, final Collection<Cell6< K2, K3, K4, K5, K6,V>> foundValues) throws IOException {
		values(exactValue, null, null, foundValues);
	}
	
	public final void values(final K1 minimumValue, final K1 maximumValue, final Collection<Cell6< K2, K3, K4, K5, K6,V>> foundValues) throws IOException {
	...
	private final void values(final K1 exactValue, final K1 minimumValue, final K1 maximumValue, 
			final Collection<Cell6< K2, K3, K4, K5, K6,V>> foundValues) throws IOException {
		if ( null == data) {
			System.err.println("Null Data - It should be an warning");
			return;
		}
		...
		for (int position : foundPositions) {
			...
			foundValues.add( new Cell6< K2, K3, K4, K5, K6,V>(
				k2Sorter,k3Sorter,k4Sorter,k5Sorter,k6Sorter, vSorter, sec));
		}
		ObjectFactory.getInstance().putIntegerList(foundPositions);
	}
	
	public final Collection<Cell6< K2, K3, K4, K5, K6,V>> values() throws IOException {
		Collection<Cell6< K2, K3, K4, K5, K6,V>> values = new ArrayList<Cell6< K2, K3, K4, K5, K6,V>>();
		values(values);
		return values;
	}	
	
	public final void values(final Collection<Cell6< K2, K3, K4, K5, K6,V>> values) throws IOException {
		if ( null == data) {
			System.err.println("Null Data - It should be an warning");
			return;
		}
		...
		for ( int i=0; i<size; i++) {
			...
			BytesSection sec = new BytesSection(data.data, ref.offset, ref.length);
			values.add( new Cell6< K2, K3, K4, K5, K6,V>( k2Sorter,k3Sorter,k4Sorter,k5Sorter,k6Sorter, vSorter, sec) );
		}
	}
	...
	public final void parseElements() throws IOException {
		...
		for ( int i=0; i<sizeK; i++) {
			valSorter.getValueAtReference(i, ref);
			BytesSection sec = new BytesSection(data.data, ref.offset, ref.length);
			sortedList.put(k1Sorter.getValueAt(i), new Cell6< K2, K3, K4, K5, K6,V>( k2Sorter,k3Sorter,k4Sorter,k5Sorter,k6Sorter, vSorter, sec));
		}
	}
	...
	public final class Callback extends EmptyList {
		...
		Map<K1, Cell6< K2, K3, K4, K5, K6,V>> rows;
		
		public Callback(final Map<K1, Cell6< K2, K3, K4, K5, K6,V>> rows, final ISortedByte<byte[]> valSorter ) {
			this.rows = rows;
		...
		public final boolean add(final Integer position) {
			...
			Cell6< K2, K3, K4, K5, K6,V> cell = new Cell6< K2, K3, K4, K5, K6,V>(
				k2Sorter,k3Sorter,k4Sorter,k5Sorter,k6Sorter, vSorter, valueSection);
