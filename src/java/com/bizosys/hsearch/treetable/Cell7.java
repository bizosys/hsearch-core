...
public class Cell7< K1, K2, K3, K4, K5, K6,V> extends CellBase<K1> {
	...
	public void getMap(K1 exactValue, K1 minimumValue, K1 maximumValue, Map<K1, Cell6< K2, K3, K4, K5, K6,V>> rows) throws IOException 
	{
		if ( null == data) {
	...
	public void parseElements() throws IOException {
		...
		List<Cell6< K2, K3, K4, K5, K6,V>> allValues = new ArrayList<Cell6< K2, K3, K4, K5, K6,V>>(allKeysT);
		values(allValues);
		...
		Iterator<Cell6< K2, K3, K4, K5, K6,V>> itrVal = allValues.iterator();
	...
	public final class Callback extends EmptyList {
		...
		public Callback(Map<K1, Cell6< K2, K3, K4, K5, K6,V>> rows, ISortedByte<byte[]> valSorter ) {
			this.rows = rows;
