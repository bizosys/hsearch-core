...
public final class Cell5< K1, K2, K3, K4,V> extends CellBase<K1> {
	...
	public final void getNotMap(final K1 exactValue, final Map<K1, Cell4< K2, K3, K4,V>> rows) throws IOException 
	{
		if ( null == data) {
			System.err.println("Null Data - It should be an warning");
			return;
	...
	public final void getInMap(final K1[] inValues, final Map<K1, Cell4< K2, K3, K4,V>> rows) throws IOException 
	{
		if ( null == data) {
			System.err.println("Null Data - It should be an warning");
			return;
