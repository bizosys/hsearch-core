...
public class Cell10< K1, K2, K3, K4, K5, K6, K7, K8, K9,V> extends CellBase<K1> {
	...
	public void parseElements() throws IOException {
		...
		List<Cell9< K2, K3, K4, K5, K6, K7, K8, K9,V>> allValues = new ArrayList<Cell9< K2, K3, K4, K5, K6, K7, K8, K9,V>>(allKeysT);
		values(allValues);
		...
		Iterator<Cell9< K2, K3, K4, K5, K6, K7, K8, K9,V>> itrVal = allValues.iterator();
