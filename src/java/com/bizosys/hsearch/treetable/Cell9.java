...
public class Cell9< K1, K2, K3, K4, K5, K6, K7, K8,V> extends CellBase<K1> {
	...
	public void getMap(K1 exactValue, K1 minimumValue, K1 maximumValue, Map<K1, Cell8< K2, K3, K4, K5, K6, K7, K8,V>> rows) throws IOException 
	{
		...
		for (int position : foundPositions) {
			Cell8< K2, K3, K4, K5, K6, K7, K8,V> cell5 = new Cell8< K2, K3, K4, K5, K6, K7, K8,V>(
					k2Sorter,k3Sorter,k4Sorter,k5Sorter,k6Sorter,k7Sorter,k8Sorter, vSorter, valuesA.getValueAt(position) );
