...
public class SearchIndexTest extends TestCase {
	...
	public static String[] modes = new String[] { "all", "random", "method"};
		...
		public static void main(String[] args) throws Exception {
			SearchIndexTest t = new SearchIndexTest();
		...
		public void testAddOnEmptySet() throws Exception {
			...
			Cell6<Integer, String, Integer, Integer, Integer, Float> wordHash_word_docType_wordType_docId_termWeight = getSearchTable();
			...
			for (String aLine : lines) {
				...
				wordHash_word_docType_wordType_docId_termWeight.put( 
					Integer.parseInt(fld[0]), fld[1] , Integer.parseInt(fld[2]), Integer.parseInt(fld[3]), Integer.parseInt(fld[4]) , Float.parseFloat(fld[5]));
			}
			wordHash_word_docType_wordType_docId_termWeight.sort (new CellComparator.FloatComparator<Integer>());


			byte[] data = wordHash_word_docType_wordType_docId_termWeight.toBytes();
